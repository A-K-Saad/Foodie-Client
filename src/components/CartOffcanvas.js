  ...
  return (
    <>
      ...
      <div
        ...
        } h-screen transform border-l border-gray-200 transition ease-in-out duration-500 fixed inset-y-0 right-0 max-w-full flex overflow-hidden z-40`}
      >
        <div class="w-screen max-w-md flex flex-col bg-white">
          {/* cart header */}
          <div class="px-4 py-4 border-b border-gray-200 flex items-start justify-between">
          ...
          {/* cart body */}
          <div class="flex-1 overflow-y-auto px-4 sm:px-6 mt-6">
            <div class="flow-root">
